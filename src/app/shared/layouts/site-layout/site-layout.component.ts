...
export class SiteLayoutComponent implements AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    // this.productBrandSizes = this.productBrands[0].size;
    // this.sizesArr = Object.values(this.productSizes)
  ...
  ngAfterViewInit(): void {
    ...
    console.log('resize ngAfterViewInit');
