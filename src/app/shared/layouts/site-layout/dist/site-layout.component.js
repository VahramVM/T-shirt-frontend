...
var SiteLayoutComponent = /** @class */ (function () {
    ...
    SiteLayoutComponent.prototype.productSize = function () {
        this.productSizes = this.productBrands[0].size;
        // for (let i = 0; i < Object.keys(this.productBrands[0].size).length; i++) {
        //   const element = [i];
        // }
    ...
    SiteLayoutComponent.prototype.productBrandColor = function () {
        ...
        var filterByColorBrand = this.arrColor.filter(function (o1) { return _this.productBrandColors.some(function (o2) { return o1 === o2; }); });
